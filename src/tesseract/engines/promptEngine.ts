/**
 * Jarvis Infinity System — Prompt Engine
 * Prompt cards and context builders
 */
...
export function buildTodayContext(data: any): string {
...
export function buildFullContext(data: any): string {
  return [
