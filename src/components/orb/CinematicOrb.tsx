...
function buildModeSignatureGeometry(palette: EnergyPalette) {
  const seedMap: Record<EnergyPalette, number> = {
    gold: 99281,
    blue: 60319,
    green: 84011,
    red: 19441,
...
function makeModeConduitCurves(palette: EnergyPalette) {
